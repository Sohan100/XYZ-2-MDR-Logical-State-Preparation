#!/bin/bash
#SBATCH --job-name=surface_array
#SBATCH --output=surface_array_%A_%a.out
#SBATCH --error=surface_array_%A_%a.err
#SBATCH -C cpu
#SBATCH -q regular
#SBATCH -t 47:30:00
#SBATCH --nodes=1
