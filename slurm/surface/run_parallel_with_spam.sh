#!/bin/bash
#SBATCH --job-name=surface_with_spam
#SBATCH --output=surface_with_spam_%j.out
#SBATCH --error=surface_with_spam_%j.err
#SBATCH -C cpu
#SBATCH -q regular
#SBATCH -t 47:30:00
#SBATCH --nodes=18
...
for NOISE_MODEL in "${NOISE_MODELS[@]}"; do
    for DISTANCE in "${DISTANCES[@]}"; do
        RUN_NAME="Run-${TIMESTAMP}-d${DISTANCE}-${NOISE_MODEL}-with-spam"
