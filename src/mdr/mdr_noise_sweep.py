...
class MdrNoiseSweep:
    ...
    def _metric_series_for_operator(
        ...
        NumPy arrays ordered by increasing parameter tuple. It supports the
        legacy observable-loss metric plus a backwards-compatible
